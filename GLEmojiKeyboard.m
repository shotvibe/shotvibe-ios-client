...
- (instancetype)initWithView:(UIView*)view {
    ...
    if (self) {
        ...
        self.view = [[UIView alloc] initWithFrame:CGRectMake(0, -view.frame.size.height*0.7, [[UIScreen mainScreen] bounds].size.width, view.frame.size.height*0.7)];
...
//        self.scrollView.contentSize = CGSizeMake(<#CGFloat width#>, <#CGFloat height#>);
        ...
        self.scrollView.contentSize  = CGSizeMake(self.view.frame.size.width*11, view.frame.size.height*0.7);
