...
//    GLContainersViewController * glContainer = [[GLContainersViewController alloc] init];
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"kUserLoggedIn"]) {
        ...
        //        SVRegistrationViewController * registrationViewControler = [[SVRegistrationViewController alloc] init];
        ...
        GLContainersViewController * containersVc = [[GLContainersViewController alloc] init];
    ...
    //        [self.navigationController presentViewController:welcomeViewController animated:NO completion:^{
    ////
    ////
    //        }];
