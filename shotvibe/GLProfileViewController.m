//
//  GLProfileViewController.m
//  shotvibe
//
//  Created by Tsah Kashkash on 31/10/2015.
...
@interface GLProfileViewController ()
...
@implementation GLProfileViewController
...
- (void)viewDidLoad {
    ...
    [StoryCommentCell setTableViewWidth:self.view.frame.size.width];
    
    // Create ParallaxHeaderView with specified size, and set it as uitableView Header, that's it
    ParallaxHeaderView *headerView = [ParallaxHeaderView parallaxHeaderViewWithCGSize:CGSizeMake(self.view.frame.size.width, 300)];
