...
- (void)carousel:(__unused iCarousel *)carousel didSelectItemAtIndex:(__unused NSInteger)index locationInView:(__unused CGPoint)location {}
...
//            UIView* subview = [self hitTest:[tapGesture locationInView:self.parentView] withEvent:nil];
            [_delegate carousel:self didSelectItemAtIndex:index locationInView:[tapGesture locationInView:self.parentView]];
...
- (void)mouseUp:(NSEvent *)theEvent
{
    if (!_didDrag)
    {
        ...
        if (index != NSNotFound)
        {
            ...
            {
                [self pushAnimationState:YES];
                [_delegate carousel:self didSelectItemAtIndex:index locationInView:position];
                [self popAnimationState];
            }
        }
    }
