        ...
        if (granted) {
            ...
            dispatch_async(abQueue, ^{
                ...
                for (id evaluatedObject in contacts) {
                    ...
                    // Make sure the fullname has a minimum length of 1
                    NSString *fullname = [NSString stringWithFormat:@"%@%@%@", lastName, (lastName.length == 0 && firstName.length > 0) ? @"":@" ", firstName];
                    ...
                    if (num == 0) {
                        ...
                        for (CFIndex i = 0; i < num; i++) {
                            ...
                            if (ABPersonHasImageData((__bridge ABRecordRef)evaluatedObject)) {
                                record.iconLocalData = (__bridge_transfer NSData *)(ABPersonCopyImageDataWithFormat((__bridge ABRecordRef)evaluatedObject, kABPersonImageFormatThumbnail));
                            }
